...
rdfs:label@es: "tiene nota sobre la encuadernación"
...
skos:definition@es: "Relaciona un recurso con una nota sobre la encuadernación como fue publicada por el editor."
skos:scopeNote: Excludes a binding specific to a copy in hand.
skos:scopeNote@es: "Se excluye una encuadernación específica de un ejemplar que se tiene en la mano."
---
# has note on binding
...
- **Official ISBD Definition:**  The "note on binding" element provides information about the binding of a resource *as issued by the publisher*.  It pertains to the original binding and not subsequent bindings added after publication.
- **Domain and Range:** While not explicitly defined in RDF terms in this version of the ISBD, the domain would be the resource being described, and the range would be a textual note describing the binding.
