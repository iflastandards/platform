    ...
    <div className="row gx-0 me-4">
      <div className="col-md-12">
        <nav className="d-flex flex-column" aria-label="Navigation for main sections">
          ...
          <div className="d-flex align-items-center">
            <InLink to="/docs/intro" className="linkMenuEntry">Dictionary Terms</InLink>
          </div>

          <div className="d-flex align-items-center">
            <InLink to="/docs/intro" className="linkMenuEntry">Examples</InLink>
          </div>
        </nav>
      </div>
    </div>
...
<QuickStart
  ...
  elementsPath="/docs/intro"
  examplesPath="/docs/intro"
/>

<DownloadPanel
  pdfUrl="#"
  ttlUrl="/muldicat/rdf/ttl/muldicat.ttl"
  jsonLdUrl="/muldicat/rdf/jsonld/muldicat.jsonld"
  xmlUrl="/muldicat/rdf/xml/muldicat.xml"
/>
