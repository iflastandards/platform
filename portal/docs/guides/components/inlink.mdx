...
<InLink href="/docs/guides/components" className="emphasized">Component Documentation</InLink>
...
<div style={{maxWidth: '300px', border: '1px solid #ccc', padding: '10px'}}>
  <InLink href="/docs/guides/examples">
...
<InLink href="/docs/guides/examples" smartWrap={false}>
...
<Tabs>
  <TabItem value="basic" label="Basic Internal Link">
    ```jsx
    <InLink href="/docs/guides/components">
