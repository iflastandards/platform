...
export const ADMIN_PORTAL_CONFIG: Record<Environment, AdminPortalConfig> = {
  local: {
    ...
    signoutUrl: 'http://localhost:3007/auth/signout',
  ...
  preview: {
    ...
    signoutUrl: 'https://iflastandards.github.io/standards-dev/admin/auth/signout',
  ...
  development: {
    ...
    signoutUrl: 'https://jonphipps.github.io/standards-dev/admin/auth/signout',
  ...
  production: {
    ...
    signoutUrl: 'https://www.iflastandards.info/admin/auth/signout',
