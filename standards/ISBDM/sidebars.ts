  ...
  docs: [
        ...
        },
        {
          ...
          items: [
            ...
            'relationships/1291',
            {
              ...
              items: [
                { type: 'autogenerated', dirName: 'relationships/agents' },
              ],
            },
            {
              type: 'category',
              ...
              items: [
                { type: 'autogenerated', dirName: 'relationships/resources' },
              ],
            },
            {
              type: 'category',
              ...
              items: [
                { type: 'autogenerated', dirName: 'relationships/placetimes' },
              ],
            },
            {
              type: 'category',
              ...
              items: [
                { type: 'autogenerated', dirName: 'relationships/nomens' },
              ],
            },
          ],
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Display of ISBDM metadata',
          link: {
            type: 'doc',
            id: '/Display/index', // path relative to docs folder, without .mdx extension
          },
          items: [{ type: 'autogenerated', dirName: 'Display' }],
        },
      ],
    },
