...
<SeeAlso>
  <InLink href="/docs/guides/components">Component Documentation</InLink>
</SeeAlso>
...
<SeeAlso>
  <InLink href="/docs/guides/components/inlink">InLink Component</InLink> and <InLink href="/docs/guides/components/outlink">OutLink Component</InLink>
</SeeAlso>
...
<Tabs>
  ...
  <TabItem value="multiple" label="Multiple Links">
    ...
    <SeeAlso>
      <InLink href="/docs/guides/components">Component Documentation</InLink>
      {' and '}
      <InLink href="/docs/guides/components/vocabulary-table">VocabularyTable Component</InLink>
    </SeeAlso>
    ```
  </TabItem>
