...
export default function Editor(): ReactElement {
  return (
    <Layout
      title="IFLA Standards Editor"
      description="Dashboard for managing IFLA standards documentation"
    >
      <main className={styles.editorMain}>
        <div className={styles.header}>
          <h1>IFLA Standards Editor Dashboard</h1>
          <p className={styles.subtitle}>
            Manage standards, vocabularies, and documentation
          </p>
        </div>
        ...
        <div className={styles.dashboardContainer}>
            ...
            <div className={styles.projectList}>
              ...
              <div className={styles.projectCard}>
                <div className={styles.projectHeader}>
                  ...
                  <span className={clsx(styles.status, styles.review)}>
                    Under Review
                  </span>
                </div>
              ...
              <div className={styles.projectCard}>
                <div className={styles.projectHeader}>
                  <h3>RDA Entities</h3>
                  <span className={clsx(styles.status, styles.published)}>
                    Published
                  </span>
                </div>
          ...
          <section className={styles.workflowSection}>
            ...
            <div className={styles.workflowGrid}>
              <div className={styles.workflowCard}>
                ...
                <Link to="/editor" className={styles.viewAll}>
                  View all →
                </Link>
              </div>
          ...
          <section className={styles.toolsSection}>
            ...
            <div className={styles.toolsGrid}>
              <Link to="/editor" className={styles.toolCard}>
