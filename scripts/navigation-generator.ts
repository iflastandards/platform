...
class NavigationGenerator {
  ...
  async generateAllNavigation(
    ...
    console.log('🧭 Starting Navigation Generator...\n');
    ...
    for (const [namespace, config] of Object.entries(siteConfigs)) {
      ...
      try {
        ...
        console.log(`✅ Generated ${namespace} navigation`);
      } catch (error) {
        console.error(`❌ Failed to generate ${namespace} navigation:`, error);
      }
    }

    console.log('\n🎉 Navigation Generator completed!');
  }
