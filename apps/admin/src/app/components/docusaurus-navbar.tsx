...
export function DocusaurusNavbar({
  ...
  const getSiteUrl = (key: string) => {
    ...
    return (
      siteUrls[key.toLowerCase()] ||
      `http://localhost:3000/${key.toLowerCase()}/`
    );
  };
  ...
  const getBreadcrumbs = () => {
    ...
    const breadcrumbs = [{ label: 'Admin Portal', href: '/' }];
          ...
          <div className="docusaurus-navbar__breadcrumbs">
            {breadcrumbs.map((crumb, index) => (
              <React.Fragment key={crumb.href}>
                {index > 0 && (
                  <span className="docusaurus-navbar__breadcrumb-separator">
                    /
                  </span>
                )}
                <Link
              ...
              >
                ...
                <svg
                  className={`docusaurus-navbar__dropdown-arrow ${
                    isDropdownOpen
                      ? 'docusaurus-navbar__dropdown-arrow--open'
                      : ''
                  }`}
                  width="12"
                  height="12"
                    ...
                    <div className="docusaurus-navbar__dropdown-section">
                      <label className="docusaurus-navbar__checkbox-item">
                        <input
                          ...
                          onChange={(e) =>
                            handleKeepSignedInChange(e.target.checked)
                          }
