...
rdfs:label@es: "tiene área de descripción del material"
...
skos:definition@es: "Relaciona un recurso con una mención que incluye la designación específica del material y la extensión, otros detalles físicos, dimensiones y la mención de material anejo."
skos:scopeNote: Restricted to the resource as issued by the publisher.
skos:scopeNote@es: "Restringido al recurso tal y como lo publica el editor."
---
...
- **Official ISBD Definition:** The material description area includes the extent, other physical details, the dimensions, and the accompanying material statement.  These elements describe the physical characteristics of the resource.
- **Domain:**  Bibliographic resource (specifically the manifestation level in FRBR terms)
- **Range:**  A structured string of text containing extent, possibly other physical details, dimensions, and accompanying material statement.
- **Element Type:** Complex - composed of sub-elements.
