...
describe('Review Group Dashboard Routing @integration @dashboard @admin @high-priority', () => {
  ...
  describe('RG Overview Page', () => {
    it.skip('should render the RG overview page with stats and namespaces', () => {
      renderWithProviders(<RGOverviewPage reviewGroupName="ISBD" />);
  ...
  describe('RG Projects Page', () => {
    it('should render the projects page', () => {
      ...
      expect(
        screen.getByRole('link', { name: /Start New Project/i }),
      ).toBeInTheDocument();
    });
  });
  ...
  describe('RG Team Page', () => {
    it('should render the team members page', () => {
      ...
      expect(screen.getByText('Team Members')).toBeInTheDocument();
      expect(
        screen.getByRole('link', { name: /Invite Team Member/i }),
      ).toBeInTheDocument();
  ...
  describe('RG Activity Page', () => {
    it('should render the activity log page', () => {
      ...
      expect(
        screen.getByText('Recent activities in your review group'),
      ).toBeInTheDocument();
      expect(
        screen.getByText('ISBD Review Group Activity'),
      ).toBeInTheDocument();
    });
  });
});
