...
export function SharedTranslationPage({
  userRole,
}: SharedTranslationPageProps) {
  const getContent = () => {
    if (userRole === 'author') {
      return {
    ...
    return {
      ...
      alertMessage:
        'Coordinate translation efforts across multiple languages and manage translation workflows.',
    };
  };
