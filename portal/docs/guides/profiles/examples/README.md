...
The DCTAP profiles are now available for download:
...
The profiles serve as the source for generating JSON-LD contexts.
...
- JSON-LD contexts: `portal/docs/guides/profiles/contexts/`