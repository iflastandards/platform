    ...
    <div className="card" style={{
      ...
      <div className="card__body">
        ...
        <div className="tpsor" style={{ marginBottom: '1.5rem' }}>
          <div style={{ marginBottom: '0.5rem', color: 'var(--ifm-color-emphasis-800)' }}>
          ...
          <div style={{ marginBottom: '0', color: 'var(--ifm-color-emphasis-700)' }}>
        ...
        <div className="tppub">
          ...
          <div style={{ marginBottom: '0', color: 'var(--ifm-color-emphasis-800)' }}>
