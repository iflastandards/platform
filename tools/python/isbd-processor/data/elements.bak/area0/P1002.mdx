...
rdfs:label@es: "tiene aclaración de contenido"
...
skos:definition@es: "Relaciona un recurso con una subcategoría que amplía una categoría que refleja la forma o formas fundamentales en que se expresa el contenido."
...
skos:scopeNote@es: "Los calificativos del contenido especifican el tipo, presencia o ausencia de movimiento, dimensión y naturaleza sensorial del recurso que se describe."
---
...
- **Official ISBD Definition:**  A content form category is expanded by one or more content qualification sub-categories that are applicable to the resource being described. Content qualifications specify the type, presence or absence of motion, dimensionality, and sensory nature for the resource being described. (Section 0.1.1)
- **Domain:** Content Form
- **Range:**  Type, Motion, Dimensionality, Sensory Nature
