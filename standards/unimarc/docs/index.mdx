...
<div style={{ textAlign: 'center', marginBottom: '40px' }}>
  <Button type="primary" href="/elements" size="small">Browse All Element Sets</Button>
</div>
## Vocabularies
...
<div style={{ textAlign: 'center', marginBottom: '40px' }}>
  <Button type="primary" href="/vocabularies" size="small">Browse All Vocabularies</Button>
</div>
## Navigation
