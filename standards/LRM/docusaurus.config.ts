...
const siteConfig = getSiteConfig('LRM' as SiteKey, DOCS_ENV);
...
const config: Config = {
  ...
  customFields: {
    ...
    vocabularyDefaults: {
      ...
      startCounter: 1000,
      uriStyle: "numeric",
      numberPrefix: "E", // Prefix for numeric URIs. Can be blank for no prefix.
      ...
      profile: "lrm-profile-revised.csv",
      ...
      'classic',
      {
        ...
        blog: {
          ...
          feedOptions: {
            type: 'all',
            title: 'IFLA LRM Blog',
            description: 'Updates and news about IFLA LRM',
  ...
  themeConfig: {
    ...
    footer: createStandardFooter(DOCS_ENV, 'LRM'),
    prism: {
