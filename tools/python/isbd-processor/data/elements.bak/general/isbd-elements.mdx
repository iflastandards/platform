...
- **Official ISBD definition:**  The ISBD standard defines a set of data elements to be recorded or transcribed for bibliographic resources. Each element represents a distinct aspect of the resource, such as its title, edition, publication details, physical description, etc. These are grouped into 8 main areas (0-8).


- **Domain:** Bibliographic resources (monographs, serials, cartographic materials, music, electronic resources, etc., both published and unpublished)

- **Range:** Text strings, numbers, and combinations thereof, often qualified by terms or phrases indicating the source of the data or its nature.

- **Element type:** Each element has a specific definition and transcription rules within the ISBD.
