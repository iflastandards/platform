/**
 * @integration @api @low-priority @docs
 */
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest';

// Mock fs module - must be hoisted before imports
vi.mock('fs', () => ({
  existsSync: vi.fn(),
  mkdirSync: vi.fn(),
  writeFileSync: vi.fn(),
...
import { extractSidebarReferencesFromFile, expandAutogeneratedReferences } from './utils/sidebar-reference-extractor';
import { checkFilesExist, generateMissingFilesReport } from './utils/file-existence-checker';

// Get mocked functions
const mockExtractSidebarReferencesFromFile = vi.mocked(extractSidebarReferencesFromFile);
const mockExpandAutogeneratedReferences = vi.mocked(expandAutogeneratedReferences);
const mockCheckFilesExist = vi.mocked(checkFilesExist);
const mockGenerateMissingFilesReport = vi.mocked(generateMissingFilesReport);
