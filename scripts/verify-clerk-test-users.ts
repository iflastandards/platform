...
import { TEST_USER_EMAILS, TEST_USER_METADATA } from '@ifla/fixtures';
...
async function main() {
  ...
  const verifications = [
    {
      ...
      metadata: TEST_USER_METADATA.SUPERADMIN,
      role: 'Superadmin',
    },
    {
      email: TEST_USER_EMAILS.RG_ADMIN,
      metadata: TEST_USER_METADATA.RG_ADMIN,
      role: 'Review Group Admin',
    },
    {
      email: TEST_USER_EMAILS.NAMESPACE_ADMIN,
      metadata: TEST_USER_METADATA.NAMESPACE_ADMIN,
      role: 'Namespace Admin',
    },
    {
      email: TEST_USER_EMAILS.EDITOR,
      metadata: TEST_USER_METADATA.EDITOR,
      role: 'Editor',
    },
    {
      email: TEST_USER_EMAILS.AUTHOR,
      metadata: TEST_USER_METADATA.AUTHOR,
      role: 'Author',
    },
    {
      email: TEST_USER_EMAILS.TRANSLATOR,
      metadata: TEST_USER_METADATA.TRANSLATOR,
      role: 'Translator',
    },
  ];
  ...
  // Overall status
  const allCorrect =
    existing.length === results.length && correct.length === existing.length;
