...
import { ElementSetCard, VocabularyCard, NamespaceHub } from '@ifla/theme';
...
<div style={{ textAlign: 'center', marginBottom: '40px' }}>
  <Button variant="contained" href="/elements" size="small">Browse All Element Sets</Button>
</div>
## Vocabularies
...
<div style={{ textAlign: 'center', marginBottom: '40px' }}>
  <Button variant="contained" href="/vocabularies" size="small">Browse All Vocabularies</Button>
</div>
## Navigation
